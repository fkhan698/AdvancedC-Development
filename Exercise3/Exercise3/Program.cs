...
namespace Exercise3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var shipAmount = CalculateShipping(shippableItems);
            Console.WriteLine($"Total ship amount:{shipAmount}");
            ...
            Console.WriteLine("=====================");
            Console.WriteLine($"Total amount: {shipAmount + taxAmount}");
    ...
    public class Book : IPurchasable, ITaxable, IShippable
    {
        ...
        {
            var shippingRate = 2;
            Console.WriteLine($"ShippingRate: = {shippingRate}");
            return shippingRate;
        }
    }
